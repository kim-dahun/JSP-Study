        ...
        <nav class="nav-tabs navbar navbar-expand-lg bg-body-light">
            <ul class="navbar-nav bg-light">
                ...
                <li class="nav-item"><c:url var="postlist"
                    ...
                    </c:url> <a class="nav-link" href="${postlist }">포스트 목록</a>
                </li>
            </ul>
        </nav>
        <main class="my-2">
            <section class="card">
                <form class="card-body">
                    ...
                    <div class="my-2">
                        ...
                        <textarea class="form-control" id="content"
                            name="content" readonly="readonly">${post.content }</textarea>
                    </div>
                    <div class="my-2">
                    ...
                    <div class="my-2">
                        <fmt:formatDate value="${post.createdTime }"
                            var="createdTime" pattern="yyyy-MM-dd HH:mm" />
                        <label class="form-label for="createdTime">최초
                            작성 시간</label> <input class="form-control"
                            id="createdTime" name="createdTime"
                            readonly="readonly" value="${ createdTime }" />
                    </div>
                    <div class="my-2">
                        <fmt:formatDate value="${post.modifiedTime }"
                            var="modifiedTime"
                            pattern="yyyy-MM-dd HH:mm" />
                        <label class="form-label for="modifiedTime">최종
                            수정 시간</label> <input class="form-control"
                            id="modifiedTime" name="modifiedTime"
                            readonly="readonly" value="${ modifiedTime}" />
                    </div>
                ...
                <div class="card-footer my-2">
                    ...
                    <a href="${postModifyPage }"><button
                            class="form-control btn btn-outline-primary">수정하기</button></a>
                </div>
            </section>
            <!-- 포스트 상세보기 카드 끝 부분 -->
                    ...
                    <div class="row my-2">
                        ...
                        <div class="col-10">
                            <textarea class="form-control"
                                ...
                                autofocus="autofocus" required></textarea>
                            <input class="d-none" id="writer"
                                name="writer" value="admin" />
                            <!-- TODO -->
                        </div>
                        <div class="col-2">
                            <button id="btnAddReply"
                                class="form-control btn btn-outline-primary">등록</button>
                        </div>
                    </div>
                    <!-- 댓글 목록 -->
                    <div id="replies" class="row my-2"></div>
            ...
            <!-- 댓글 수정 모달 -->
            <div class="modal" id="replyUpdateModal" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button id="modalBtnUpdate" type="button"
                                class="btn btn-primary">변경내용 저장
                            </button>
                        </div>
                    </div>
                </div>
