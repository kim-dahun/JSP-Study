...
document.addEventListener('DOMContentLoaded',()=>{
    ...
    // args data : Ajax 요청의 응답으로 전달받은 데이터.
    ...
    const makeReplyElements = (data) => {
        // 댓글 갯수 업데이트
        replyCountSpan.innerHTML = data.length; // 배열 길이, 원소 갯수
        
        replies.innerHTML = ''; // <div> 컨텐트를 지움.
        
        let htmlStr = '';
        // for(let i in data) // 인덱스 iteration
        // for(let i of data) // 원소 iteration
