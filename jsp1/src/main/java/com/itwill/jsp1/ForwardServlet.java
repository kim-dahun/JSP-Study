...
public class ForwardServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    // 같은 WAS(Web Application Server)에 같은 웹 애플리케이션 안에서만 페이지 이동이 가능.
	    // 요청 주소(URL) 가 바뀌지 않음.
	    // Request, Response 객체가 유지됌.
	    // 다른 웹 서버, 다른 웹 애플리케이션의 페이지로 Forward 이동을 할 수 없음.
	    
	    // src/main/web-app 폴더 아래에 파일 경로와 파일 이름을 사용.
